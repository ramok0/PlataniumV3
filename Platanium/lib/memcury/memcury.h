...
namespace Memcury
{
    ...
    public:
        ...
        {
            std::vector<int> bytes = Memcury::ASM::pattern2bytes(pattern);
            return ScanFor(bytes, forward, toSkip);
        }

        auto ScanFor(std::vector<int> opcodesToFind, bool forward = true, int toSkip = 0) -> Scanner
        {
